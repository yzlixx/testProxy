...
public class Test {
    ...
    private static void createProxy() throws Exception
    {
        ...
        //设置接口
        CtClass interface1 = pool.get("com.lixiaoxuan.ticket.TicketService");
        cc.setInterfaces(new CtClass[]{interface1});

        //设置Field
        CtField field = CtField.make("private com.lixiaoxuan.ticket.Station station;", cc);

        cc.addField(field);

        CtClass stationClass = pool.get("com.lixiaoxuan.ticket.Station");
        ...
        cc.writeFile("target/classes/com/lixiaoxuan/ticket/proxy");
    }
}
